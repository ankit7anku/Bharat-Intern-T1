...
The objective of this project is to predict stock price of any company by using Long Short-Term Memory (LSTM).
...
Please look into the following links for analysis.
